...
<form action="#" method="post"  enctype="multipart/form-data">
    ...
    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="assignment" name="assignment" placeholder="Assignment Result" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter Assignment Result here">
          <label for="floatingInput">Assignment Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="quiz" name="quiz" placeholder="Quiz Result" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter Quiz Result here">
          <label for="floatingInput">Quiz Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="midExam" name="midExam" placeholder="Mid Exam Result" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter Mid Exam Result here">
          <label for="floatingInput">Mid Exam Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="practice" name="practice" placeholder="Practice Result" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter Practice Result here">
          <label for="floatingInput">Practice Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="final" name="final" placeholder="Final Result" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter Final Result here">
