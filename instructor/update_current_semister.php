                 ...
                 <?php
                   ...
                   ?>
                        <tr>
                          ...
                          <td><a  href="current_semister_update.php?year=<?php echo $year;?>&semister=<?php echo $semister;?>&program=<?php echo $program;?>&section=<?php echo $section;?>" class="btn btn-success" > Select </a></td>
                        </tr><?php } ?>
                  </tbody>
              </table>
