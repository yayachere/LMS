  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.php" class="logo d-flex align-items-center" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Instructor Home Page">
        <img src="../assets/img/vrslogo.png" alt="logo">
        <span class="d-none d-lg-block">Instructor Page</span>
      </a>
