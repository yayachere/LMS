...
if (isset($_POST['save'])) {   
    ...
    elseif ($final > $finalWeight) {
      ...
      $sql = mysqli_query($conn, "UPDATE grade SET assignment = '$assignment', quiz = '$quiz', practice = '$practice', mid_exam = '$midExam', final = '$final', total = '$total', instructor = 'submit', head = '', WHERE id = '$id'") or die(mysqli_error($conn));
...
<form action="#" method="post"  enctype="multipart/form-data">
    ...
    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="assignment" name="assignment" value="<?php echo $assignment;?>" >
          <label for="floatingInput">Assignment Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="quiz" name="quiz" value="<?php echo $quiz;?>" >
          <label for="floatingInput">Quiz Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="midExam" name="midExam" value="<?php echo $midExam;?>" >
          <label for="floatingInput">Mid Exam Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="practice" name="practice"  value="<?php echo $practice;?>">
          <label for="floatingInput">Practice Result</label>
        </div>

    <div class="form-floating mb-3">
          <input type="number" class="form-control" id="final" name="final" value="<?php echo $final;?>">
    ...
    <div class="row mb-3 mt-3">
      <div class="col-sm-10 text-center">
        ...
        <a href="previous_semister.php" class="btn btn-dark">Back</a>
      </div>
    </div>
