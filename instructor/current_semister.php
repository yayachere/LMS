          ...
          <div class="card" style="overflow-x: auto;">
            <div class="card-body">
              ...
              <table class="table datatable">
                  ...
                  <tbody>
                 <?php
                    $querys = mysqli_query($conn,"SELECT * FROM assigned_course WHERE instructor_id = '$session_id' and status = 'active'");
                   ...
                   ?>
                        <tr>
                          ...
                          <td><a  href="semister_current.php?ID=<?php echo $id;?>" class="btn btn-success" > Select </a></td>
                        </tr><?php } ?>
                  </tbody>
              </table>
