...
<main id="main" class="main">
  ...
  <?php
                                  ...
                                  $querys = mysqli_query($conn,"SELECT * FROM users_account WHERE account_type = 'head' || account_type =  'instructor'");
                  $array = array();
              ...
              <td class="center"><a  href=" activate_head.php?ID=<?php echo $idnum;?> " data-toggle="modal" class="btn btn-success">Detail</a></td>
                        </tr> <?php } ?>
                </tbody>
              </table>
