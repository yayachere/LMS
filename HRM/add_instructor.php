  ...
  <main id="main" class="main">
    ...
    <section class="section">
      <div class="row">
        ...
        <div class="card">
            <div class="card-body">
              <h5 class="card-title">Fill Head & Instructor Information Below</h5>
...
//check if the user exists
 ...
 //Send mail by PHP Mail Function
  ...
  echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
      ...
      mysqli_query($conn,"insert into instructor( user_id,first_name,middle_name,
        last_name,document,email,phone,department,registered_on,gender,school) values('$userId','$firstName','$middleName','$lastName','$document','$email','$phone','$department','$registered_on','$gender','$school')")or die(mysqli_error($conn));
...
echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
      ...
      <a href='print_instructor.php?firstName=<?php echo $firstName;?>&lastName=<?php echo $middleName;?>&userId=<?php echo $userId;?>&password=<?php echo $passwordd;?>' class="btn btn-success">Print</a> 
...
<form action="#" method="post"  enctype="multipart/form-data">
    ...
    <div class="form-floating mb-3">
          <input type="text" class="form-control" id="school" name="school" placeholder="Enter School" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter School" required>
          <label for="floatingInput">School</label>
    </div>

    <div class="form-floating mb-3">
          <input type="text" class="form-control" id="department" name="department" placeholder="Enter Department" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Enter Department" required>
    ...
    <div class="form-floating mb-3">
          ...
          <label for="floatingInput">Instructor Document</label>
    </div>
