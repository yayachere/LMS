...
<?php
                                ...
                                $user_id = $session_id;
                                $qry = mysqli_query($conn, "SELECT * FROM users_account where user_id = '$user_id'");
                                $rw = mysqli_fetch_assoc($qry);
                                $accountType = $rw['account_type'];
                                $queryhead = mysqli_query($conn, "SELECT * FROM instructor WHERE user_id = '$session_id'") or die(mysqli_error($conn));
                                $row = mysqli_fetch_array($queryhead);
                                $school = $row['school'];
                    ...
                    $query = "INSERT INTO news(header,message,posted_to,posted_on,type,expire,posted_by,account_type,school,department) values('$header','$message','$post_to','$posted_on','$post_type','$expire','$user_id','$accountType','$school','$department')"or die(mysqli_error($conn));
