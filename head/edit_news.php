        ...
        <div class="col-12">
          ...
          $query = mysqli_query($conn,"SELECT * FROM news order by id");
            while($row = mysqli_fetch_assoc($query) >= 1){
              ...
              if ($up_on == null) {
                $qry = mysqli_query($conn,"SELECT * FROM news where posted_by = 'head' order by id desc");
              }else {
                $qry = mysqli_query($conn,"SELECT * FROM news where posted_by = 'head' order by updated_on desc");
              }
