                  ...
                  $school = $row['school'];
                   ...
                   ?>
                        <tr>
                          ...
                          <td><a  href="course_delete.php?school=<?php echo $school;?>&department=<?php echo $department;?>&year=<?php echo $year;?>&semister=<?php echo $semister;?>&program=<?php echo $program;?>" class="btn btn-danger" > Delete </a></td>
                        </tr><?php } ?>
                  </tbody>
              </table>
